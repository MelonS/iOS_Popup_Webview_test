...
- (void)navigationBarSetting {
    self.webViewController.navigationItem.title = @"Title";
    self.webViewController.navigationController.navigationBar.barStyle = UIBarStyleBlack;
    self.webViewController.navigationController.navigationBar.barTintColor = [UIColor blueColor];
    self.webViewController.navigationController.navigationBar.translucent = NO;
}
